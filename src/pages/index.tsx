...
import { Building2, Users, Briefcase, GraduationCap, Menu, X, ArrowUp } from 'lucide-react'
...
export default function UnifiedCareersPage() {
  ...
  return (
    <div className="min-h-screen bg-[#A8E6CF] flex flex-col">
      {/* Header */}
      <header className="sticky top-0 z-50 w-full border-b bg-[#DCEDC1]">
        <div className="container flex h-16 items-center justify-between">
          ...
          {isMobile ? (
            ...
            <nav className="flex items-center gap-4 text-sm">
              {navItems.map((item) => (
                <Button key={item} variant="ghost" className="text-[#4A4A4A] hover:bg-[#DCEDC1] hover:text-[#4A4A4A]">
                  {item}
                </Button>
              ))}
            </nav>
      ...
      {isMobile && (
        <div
          className={`fixed inset-0 bg-[#DCEDC1] z-40 transform transition-transform duration-300 ease-in-out ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card className="group hover:shadow-lg transition-shadow bg-white">
              <CardHeader className="bg-[#DCEDC1] rounded-t-lg">
                ...
                <CardDescription className="text-[#7C7C7C]">キャリアを築くチャンス</CardDescription>
              </CardHeader>
            ...
            <Card className="group hover:shadow-lg transition-shadow bg-white">
              <CardHeader className="bg-[#DCEDC1] rounded-t-lg">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-[#4A4A4A]">アルバイト・パート募集</CardTitle>
                </div>
                <CardDescription className="text-[#7C7C7C]">柔軟な働き方を実現</CardDescription>
              </CardHeader>
              <CardContent className="p-6 flex flex-col h-full">
                <div className="mb-4 relative h-48 rounded-lg overflow-hidden">
                  <Image
            ...
            <Card className="group hover:shadow-lg transition-shadow bg-white">
              <CardHeader className="bg-[#DCEDC1] rounded-t-lg">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-[#4A4A4A]">インターンシッププログラム</CardTitle>
                </div>
                <CardDescription className="text-[#7C7C7C]">実践的な経験を積むチャンス</CardDescription>
              </CardHeader>
              <CardContent className="p-6 flex flex-col h-full">
                <div className="mb-4 relative h-48 rounded-lg overflow-hidden">
                  <Image
            ...
            <Card className="group hover:shadow-lg transition-shadow bg-white">
              <CardHeader className="bg-[#DCEDC1] rounded-t-lg">
                ...
                <CardDescription className="text-[#7C7C7C]">成長を支援する環境</CardDescription>
              </CardHeader>
              <CardContent className="p-6 flex flex-col h-full">
                <div className="mb-4 relative h-48 rounded-lg overflow-hidden">
                  <Image
